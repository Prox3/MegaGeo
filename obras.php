...
<div id="content-home">
    ...
    <div class="title_page">
    	<font class="arrow_page"></font>OBRAS
    </div>
    
    <div class="box_obras margin-0">
    	<img src="images/megageo-obras.jpg" width="101" height="92" alt="" title="" />
      <div class="box_title_obras">Nome da Obra</div>
      <div class="box_local_obras"><strong>Local: </strong>Local da obra</div>
      <div class="box_local_obras caracteristicas_obras">
      	<strong>Características: </strong>Informações sobre a obra Informações sobre a obra Informações sobre a obra
      </div>
    </div>
